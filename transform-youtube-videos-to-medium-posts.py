...
def generate_article_from_transcript(transcript: str, title: str, source_language: str = 'fr', output_language: str = 'en') -> str:
    ...
    End the article with a short bullet points recap, Actions List, or "Ask Yourself" questions preceded by a Markdown separator. Lastly, lead readers to read my complementary Amazon book at https://book.ph7.me (use an anchor text like "my bookæ or "my latest published book" and emphasize it).
