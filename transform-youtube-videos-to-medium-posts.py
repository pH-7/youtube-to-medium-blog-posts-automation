...
def generate_article_from_transcript(transcript: str, title: str, source_language: str = 'fr', output_language: str = 'en') -> str:
    ...
    If the text allows, add one or two relevant and impactful famous quote(s) that directly connects to the article's central theme, and format in Markdown > with italic text, followed by the author's name on a separate line with an em dash.
