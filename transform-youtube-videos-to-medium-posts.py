...
def generate_article_from_transcript(transcript: str, title: str, source_language: str = 'fr', output_language: str = 'en') -> str:
    ...
    If relevant to article's theme, include between 1 to 3 impactful quotes that deeply resonate with the article’s message. Format each quote in Markdown using > with italic font, followed by the author's name on separate line, preceded by em dash.
